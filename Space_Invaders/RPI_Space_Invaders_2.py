...
while not done:
    ...
    if gamestarted:
        ...
        if pygame.time.get_ticks() - StartTime > 1280/tickspeed:
            ...
            for x in range(0,30):print(chr(13))
            print("Your Bombammo: " + str(bombammo))
            print("Your Lifes: " + str(playerhealth))
        ...
        if gameover == True:
            ...
            print("Game Over enter your name and save your HiScore")
            print(''.join(HiScoreName))
            print(chr(32)*namepos+"_")
